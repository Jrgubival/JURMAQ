...
/**
 * CookieBanner — Consent Mode v2 implementation (constructora).
 * Gemela del de barraca, comparten contrato (gtag consent update granted/denied)
 * para que el reporting cross-app funcione.
 */
    ...
    >
      <div className="bg-white border border-[#EAEAEA] rounded-2xl shadow-[0_8px_32px_-12px_rgba(0,0,0,0.18)] p-5">
        ...
        <p className="text-sm text-[#5A5A57] leading-relaxed mb-4">
          Analytics y marketing nos ayudan a entender qué máquinas buscás y a
        ...
        <div className="flex flex-wrap gap-2">
          <button
            type="button"
            onClick={accept}
            className="inline-flex items-center gap-2 px-4 py-2 bg-[#081428] text-white text-sm font-medium tracking-[0.02em] rounded-lg hover:bg-[#111111] transition-colors"
          >
            Aceptar todo
          </button>
          <button
