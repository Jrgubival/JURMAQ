...
/**
 * Tier 6 F4: bell con badge + dropdown de notificaciones admin constructora.
 *
 * Espejo del componente barraca con paleta JURMAQ arriendo (dorado #e6b422).
 */
                  ...
                  const content = (
                    <div
                      className={`px-4 py-3 flex items-start gap-3 border-l-4 ${
                        isUnread ? borderColor : 'border-l-transparent'
                      }`}
                      style={isUnread ? { backgroundColor: '#fffbeb' } : undefined}
                    >
