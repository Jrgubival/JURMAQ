...
export const metadata: Metadata = {
  title: 'Acceso administración · JURMAQ',
...
const LOGIN_CREDENCIALES = 'https://barraca.jurmaq.cl/cuenta/login?source=admin';

/**
 * Login de administración de jurmaq.cl.
 *
 * SSO con Google (allowlist en public.users vía email/sso_email) como vía
 * rápida; el login con email+contraseña de siempre queda como respaldo.
 * Si el SSO no está configurado (sin GOOGLE_CLIENT_ID/SECRET) se redirige
 * al flujo de credenciales como antes.
 */
    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          <span className="text-3xl font-extrabold text-navy-950 tracking-tight">JURMAQ</span>
