 ...
 *
 * Marca todas las notificaciones de los últimos 30 días como leídas
 * para el usuario actual. Útil para botón "marcar todas leídas".
 */
...
export async function POST(request: NextRequest) {
  ...
  // Trae todas las notifs recientes que NO tienen lectura previa de este user.
