...
/**
 * Tier 6 F4: vista completa de notificaciones admin.
 */
...
const KIND_LABEL: Record<string, string> = {
  review_pendiente: 'Review pendiente',
  comision_devengada: 'Comisión devengada',
  cotizacion_nueva: 'Cotización nueva',
  carrito_abandonado_conv: 'Carrito recuperado',
  mantencion_proxima: 'Mantención próxima',
  stock_bajo: 'Stock bajo',
  cotizacion_arriendo_nueva: 'Cotización arriendo',
  otro: 'Otro',
};
